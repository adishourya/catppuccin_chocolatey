local color_palette = {
	...
	color6 = "#bb8a8a", -- mapper : Substitute , Search , IncSearch , keyword , PreProc , Include , Special , htmlH1 , diffIndexline
	...
	color9 = "#8abb9a", -- mapper : CursorLineNr , SpellRare , TablineSel , String , diffAdded , DiffAdd
